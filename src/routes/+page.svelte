<script>
	...
	let height = "5px";
	/**@type {import("$lib/types").default['position']}*/
	let position = "bottom";
	let zIndex = 9999;
</script>
...
<svelte:head>
	...
	<meta name="description" content="A component which displays your progress as you scroll" />
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/water.css@2/out/water.css" />
</svelte:head>

<Component {color} {background} {height} {position} />

<main>
	<section>
		<h1>Svelte ScrollProgress</h1>
		<p>Shows your scroll progress, as you scroll</p>
	</section>
	<div>
		<h2>Options</h2>
		<div>
			<label for="color">Colour (Enter any valid CSS color)</label>
			<input type="text" bind:value={color} />
		</div>
		<div>
			<label for="background">Background (Enter any valid CSS colour)</label>
			<input type="text" bind:value={background} id="background" />
		</div>
		<div>
			<label for="height">Height (Enter any valid CSS sizing unit)</label>
	...
	<div>
		...
		<ul>
			<li>
				pnpm<br />
				<code>pnpm add -D svelte-scrollprogress</code>
			</li>
			<li>
				npm<br />
				<code>npm install -D svelte-scrollprogress</code>
			</li>
			<li>
				yarn<br />
				<code>yarn add -D svelte-scrollprogress</code>
			</li>
		</ul>
	</div>
	<div>
		<h2>Usage</h2>
		<p>Using this component is very easy. Just import it and you are good to go</p>
		<pre class="shiki" style="background-color: #0F111A"><code><span class="line"><span style="color: #89DDFF">&lt;</span><span style="color: #F07178">script</span><span style="color: #89DDFF">&gt;</span></span>
<span class="line"><span style="color: #A6ACCD">    </span><span style="color: #89DDFF; font-style: italic">import</span><span style="color: #A6ACCD"> Progress </span><span style="color: #89DDFF; font-style: italic">from</span><span style="color: #A6ACCD"> </span><span style="color: #89DDFF">"</span><span style="color: #C3E88D">svelte-scrollprogress</span><span style="color: #89DDFF">"</span></span>
<span class="line"><span style="color: #89DDFF">&lt;/</span><span style="color: #F07178">script</span><span style="color: #89DDFF">&gt;</span></span>
<span class="line"><span style="color: #A6ACCD">			</span></span>
<span class="line"><span style="color: #89DDFF">&lt;</span><span style="color: #FFCB6B">Progress</span><span style="color: #89DDFF"> </span><span style="color: #C792EA">color</span><span style="color: #89DDFF">="</span><span style="color: #C792EA">{color}</span><span style="color: #89DDFF">" </span><span style="color: #C792EA">background</span><span style="color: #89DDFF">="</span><span style="color: #C792EA">{background}</span><span style="color: #89DDFF">" </span><span style="color: #C792EA">zIndex</span><span style="color: #89DDFF">=</span><span style="color: #F78C6C">{zIndex}</span><span style="color: #89DDFF"> </span><span style="color: #C792EA">height</span><span style="color: #89DDFF">="{height}" <span style="color: rgb(199, 146, 234);">position</span><span style="color: rgb(137, 221, 255);">="</span><span style="color: rgb(199, 146, 234);">{position}</span><span style="color: rgb(137, 221, 255);">" </span>/&gt;</span></span>
<span class="line"><span style="color: #A6ACCD">		</span></span></code></pre>
	</div>
	<div>
		<h2>Customization</h2>
		<p>This component is very customizable, almost everything can be changed</p>
		<table>
			<thead>
				<tr>
					<th>Property</th>
			...
			<tbody>
				...
				<tr>
					<td>zIndex</td>
					<td>Integer</td>
					<td>The order of overlapping elements</td>
					<td>999</td>
				</tr>
				<tr>
					<td>height</td>
					<td>String</td>
					<td
						>The height or width of the scrollbar component. Any valid CSS size value is allowed</td
					>
					<td>5px</td>
				</tr>
				<tr>
	...
	<div>
		<h2>Events</h2>
		<p>The component does fire some events</p>
		<table>
			<thead>
				<tr>
					<th>Event Name</th>
			...
			<tbody>
				<tr>
					<td>change</td>
					<td>This is called whenever the scroll value changes</td>
				</tr>
			</tbody>
		</table>
	</div>
